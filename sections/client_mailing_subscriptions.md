...
```nginx
POST https://api.betterplace.org/en/blogs.json?action=create&active=%5Btrue%2C+false%5D&client_id=Volksfreund&controller=api_v4%2Fclient_mailing_subscriptions&email=peter.paul%40betterplace.org&first_name=Peter&last_name=Paul&project_id=4425
```
